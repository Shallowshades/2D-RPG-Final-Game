...
public class Player_DomainExpansionState : PlayerState
{
    ...
    private bool isLevitating;              // 悬浮状态
    private bool createdDomain;

    public Player_DomainExpansionState(Player player, StateMachine stateMachine, string animationBoolName) : base(player, stateMachine, animationBoolName)
    {
    }
